    ...
    */
        ...
        console.log(formattedEmail, 'is formatted');
    
        var encryptedPW = encrypt(password);
        console.log(encryptedPW, 'is encrypted')
    
        var tweetsByTimestamp = {};
        for (var tweet of tweets) {
          tweetsByTimestamp[tweet.timestamp] = tweet.content
        }
        console.log(tweetsByTimestamp);
        ...
        var requestObject = {
          ...
          tweets: tweetsByTimestamp
        }
        
        var strObj = JSON.stringify(requestObject);
        console.log(strObj);
    
        var strParse = JSON.parse(strObj);
