...
jQuery(function($){
    ...
    $( document ).ready(function() {
      ...
      var tamponsSubtotal = 162.00 * numberTampons; // price of one case of tampons * number needed
      var padsSubtotal = 162.00 * numberPads; // price of one case of pads * number needed
      var padsOnlySubtotal = 162.00 * numberPadsOnly; // price of one case of pads * number needed
      var dispensersSubtotalModelP = 341.00 * bathrooms; // cost of a Model P * number needed (1 in each bathroom)
      var dispensersSubtotalModelE = 341.00 * bathrooms; // cost of a Model E * number needed (1 in each bathroom)
      var dispensersSubtotalModelR = 500.00 * bathrooms; // cost of a Model R * number needed (1 in each bathroom)
      var dispensersSubtotalModelO = 500.00 * bathrooms; // cost of a Model O * number needed (1 in each bathroom)
